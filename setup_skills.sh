#!/usr/bin/env bash
# ============================================================================
# Agent Skills Garden — Portable Installer (Bash)
# Run: chmod +x setup_skills.sh && ./setup_skills.sh
# ============================================================================
set -euo pipefail

echo "🌱 Creating Agent Skills Garden..."
...
# ===========================================================================
cat << 'CONSTITUTION_EOF' > skills/00-foundation/constitution.md
---
name: constitution
description: >
...
# ===========================================================================
cat << 'SCRATCHPAD_EOF' > skills/00-foundation/scratchpad.md
---
name: scratchpad
description: >
...
# ===========================================================================
cat << 'AUDITOR_EOF' > skills/00-foundation/auditor.md
---
name: auditor
description: >
...
# ===========================================================================
cat << 'LIBRARIAN_EOF' > skills/00-foundation/librarian.md
---
name: librarian
description: >
...
# ===========================================================================
cat << 'TEMPLATE_EOF' > templates/skill-template.md
---
name: <skill-name>
description: >
...
# ===========================================================================
cat << 'CLEANUP_EOF' > skills/30-implementation/cleanup.md
---
name: cleanup
description: >
...
# 7. registry.yaml
# ===========================================================================
cat << 'REGISTRY_EOF' > registry.yaml
# ==========================================================================
...
# ===========================================================================
echo ""
echo "🌱 Agent Skills Garden created successfully!"
echo ""
echo "   Structure:"
echo "   ├── registry.yaml"
echo "   ├── skills/"
