...
domain: engineering
status: published
tags: [category, build, docs, reversible]
keywords: [jsdoc, tsdoc, javadoc, docstring, doc comments, godoc, kdoc, type annotations, coverage audit, stale comments, todo fixme]
metadata:
  version: 1.0.0
