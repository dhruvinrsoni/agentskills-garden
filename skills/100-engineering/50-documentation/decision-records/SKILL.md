...
domain: engineering
status: published
tags: [category, design, docs, reversible]
keywords: [adr, architectural decision record, context decision consequences, design rationale, trade-offs, alternatives considered, superseded, decision lifecycle, rfc, knowledge capture]
metadata:
  version: 1.0.0
  dependencies: "constitution, scratchpad, adr-management"
