...
keywords: [markdown, shields.io, badges, getting started, quick start, installation guide, onboarding, documentation scaffolding, contributing, code examples, monorepo]
metadata:
  version: 1.0.0
