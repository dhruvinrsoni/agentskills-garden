...
description: >
  Interview the user to extract goals, constraints, success metrics, and
...
keywords: [goal extraction, stakeholder interview, non-functional requirements, acceptance criteria, assumptions log, scope boundary, constraint discovery, greenfield, question fatigue, sla, conflict resolution]
metadata:
  version: 1.0.0
