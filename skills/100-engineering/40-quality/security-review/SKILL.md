...
keywords: [owasp, xss, sqli, injection, secret detection, cve, input validation, authentication, authorization, cryptography, dependency scanning]
metadata:
  version: 1.0.0
  dependencies: "constitution, scratchpad, secure-coding-review"
