...
keywords: [docker, docker-compose, testcontainers, pact, contract testing, api testing, database seeding, grpc, kafka, rabbitmq, transaction rollback]
metadata:
  version: 1.0.0
  dependencies: "constitution, scratchpad, test-strategy, docker-containerization"
