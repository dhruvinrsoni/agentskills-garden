...
name: auditor
description: >
  The constitutional compliance validator. Cross-references every
  skill's output against the Constitution's three pillars and the task
  plan. Acts as "law enforcement" for the Agent Skills Garden.
license: Apache-2.0
